...
const AnnouncementCard: React.FC<AnnouncementCardProps> = ({ announcement }) => {
  ...
  return (
    <div
      ...
      className="p-[20px] gap-[10px] rounded-xl w-[50vw] min-w-min flex flex-col justify-between transition-transform duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg cursor-pointer">

...
const ClaimCard: React.FC<ClaimCardProps> = ({ claim }) => {
  ...
  return (
    <div
      ...
      className="border-neutral-200 border-[2px] p-[20px] gap-[10px] rounded-xl max-w-sm w-[75vw] min-w-[320px] flex flex-col justify-between transition-transform duration-300 ease-in-out bg-white transform hover:scale-105 hover:shadow-lg cursor-pointer">
